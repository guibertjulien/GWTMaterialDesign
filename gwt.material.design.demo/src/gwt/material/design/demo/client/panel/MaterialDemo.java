...
public class MaterialDemo extends Composite {
	...
	@UiField MaterialTransitions materialTransitions;
	...
	@UiHandler("btnTransitions")
	void onTransitions(ClickEvent e){
		changeNav(materialTransitions, "Transition", "Motion design can effectively guide the user’s attention in ways that both inform and delight. Use motion to smoothly transport users between navigational contexts, explain changes in the arrangement of elements on a screen, and reinforce element hierarchy.");
	}
